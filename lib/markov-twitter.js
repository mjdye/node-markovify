...
MarkovTwitter.prototype.init = function(options){
    ...
    this.getLocalTweets = typeof options.getLocalTweets !== 'undefined' ? options.getLocalTweets : 2;
...
MarkovTwitter.prototype.searchTweets = function(options,callback){
    ...
    function recursiveTweets(max_id){
        ...
        this.client.get('search/tweets', searchObject, function(error, tweets, response) {
            if(error){
                console.log(error)
                throw(error)
            }
